...
local lsp_provider_default = {
  ...
  color = { bg = "NONE", fg = "#83a598" },
  always_visible = false,
}

local lsp_provider_icon = {
  function()
    return " "
  end,
  separator = { left = "" },
  color = { bg = "#83a598", fg = "#1d2021", gui = "bold" },
  padding = { left = 0.5 },
}
...
lualine.setup {
  ...
  sections = {
    ...
    lualine_c = { diff },
    lualine_x = { diagnostic, lsp_provider_default },
